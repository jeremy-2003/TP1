...
public class WebhookController {
    ...
    @Autowired
    public WebhookController(ObjectMapper objectMapper, AudioDownloader audioDownloader, TranscriptionService transcriptionService) {
        ...
        try {
            ...
            for (WhatsAppWebhookInboundMessageData messageData : messages.getResults()) {
                ...
                if (messageType.equals("TEXT")) {
                    ...
                    // Procesa el mensaje de texto según tus necesidades
                ...
                System.out.println("From: " + messageData.getFrom());
            }
